...
import "./WorkdoneSection.css";

function WorkdoneSection() {
  return (
    <div>
      <div className="work-done-section pt-5 pb-5">
        <div className="container">
          <div className="row">
            <div className="col-4 text-center">
              ...
              <h1 className="work-done-card-title">0</h1>
              <h1 className="work-done-card-sub-title">Projects Completed</h1>
            </div>
            <div className="col-4 text-center">
              <svg
                width="60px"
              ...
              <hr className="hr-line" />
              <h1 className="work-done-card-title">0</h1>
              <h1 className="work-done-card-sub-title">Lines of Code</h1>
            </div>
            <div className="col-4 text-center">
              <svg
                width="60px"
              ...
              <hr className="hr-line" />
              <h1 className="work-done-card-title">0</h1>
              <h1 className="work-done-card-sub-title">Hours Worked</h1>
            </div>
          </div>
        </div>
      </div>
